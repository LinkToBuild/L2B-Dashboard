...
// interface ActionTablePanelProps {
//   open: boolean;
//   onClose: () => void;
...
// export function ActionTablePanel({
//   open,
//   onClose,
//   title,
//   showTitle = true,
...
//       <div
//         className={cn(
//           "relative flex flex-col overflow-hidden rounded-[20px] bg-white shadow-xl",
//           width,
//           maxHeight,
//           className
//         )}
...
//                 </h2>
//               )}
//               {showInfoIcon && <Info className="h-4 w-4 text-neutral-3" />}
//             </div>
...
//                 type="button"
//                 onClick={onClose}
//                 className="rounded-md p-1 text-neutral-3 hover:bg-neutral-100"
//               >
//                 <X className="h-5 w-5" />
//               </button>
//             )}
...
//           {loading ? (
//             <div className="flex min-h-[180px] items-center justify-center text-sm text-neutral-3">
//               Loading...
//             </div>
//           ) : empty ? (
//             emptyState ?? (
...
//               {showTextField && textField && <div>{textField}</div>}
//               {showTable && table && <div>{table}</div>}
//             </div>
//           )}
//         </div>

//         {showButtons && buttonCount > 0 && buttons && (
//           <div className="px-6 py-4">{buttons}</div>
//         )}
//       </div>
//     </div>
//   );
