...
//   baseColor: string;
// }) {
//   const widthPercent = Math.max(row.percentage, minWidthPercent);

//   return (
//     <div
//       className="rounded-[12px] px-[12px] py-[8px] flex items-center justify-between"
//       style={{
//         width: `${widthPercent}%`,
//         minHeight: `${rowHeight}px`,
//         backgroundColor: row.bgColor || baseColor,
//         color: row.textColor || "#FFFFFF",
//       }}
//     >
//       <div className="min-w-[160px]">
//         <p className="text-[13px] font-normal leading-[18px]">{row.title}</p>
//         {row.subtitle && (
//           <p className="text-[11px] font-normal leading-[16px]">{row.subtitle}</p>
//         )}
//       </div>
...
//             <div key={`${field.label}-${index}`} className="min-w-[72px]">
//               <p className="text-[13px] font-normal leading-[18px]">
//                 {field.label}
//               </p>
//               <p className="text-[11px] font-normal leading-[16px]">
//                 {field.value}
//               </p>
//             </div>
//           ))}
...
//   rowGap = 14,
//   rowHeight = 52,
//   baseColor = "rgba(72, 137, 188, 0.96)",
// }: FunnelBarProps) {
//   return (
...
//         <div
//           key={`${row.title}-${index}`}
//           style={{ marginBottom: index === rows.length - 1 ? 0 : `${rowGap}px` }}
//         >
//           <FunnelBarItem
//             row={row}
